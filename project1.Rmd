...
################## IF RUNNING IN RSTUDIO, UNCOMMENT THE TWO LINES BELOW ####################
#pricing <- read.csv(file.choose(),head=TRUE,sep=",",as.is=TRUE)
#historical_data <- read.csv(file.choose(),head=TRUE,sep=",")

################## WHEN READY TO KNIT, UNCOMMENT THE THREE LINES BELOW ##################
######################### AND COMMENT THE TWO ABOVE #####################################
setwd("/Users/malarcon/Google Drive/CUNY/IS606/collaborative1")
pricing <- read.csv("./details.csv",head=TRUE,sep=",",as.is=TRUE)
historical_data <- read.csv("./sales.csv",head=TRUE,sep=",")
