...
pricing <- read.csv(file.choose(),head=TRUE,sep=",",as.is=TRUE)

#Capitalize sandwich type
historical_data <- read.csv(file.choose(),head=TRUE,sep=",")
head(pricing)
...
qplot(demand, data=historical_pivoted, 
      geom=c("density"),
      main="Distribution of Veggie Sandwich Demand by Month",
      xlab= "Demand",
      xlim=c(0,40),
      ylab="Density",
...
The table below shows James' current profit and expected profit based on the recomended production levels.
...
This recommendation is based on the data that James collected from Mar.2013 to Aug.2013. As we analysed above, the main reason that James could not maximise his profit was on supply deficiency of Turkey and Veggie sandwiches.
