...
As we can see from the charts above, there seems to be some variation in the order volume by month. We need to prove that it is statistically significant.

### Demand - Analysis of Variance of Seasonal Variation
The fluctuations in demant lead us to believe that there may be some seasonal fluctiations. We need to test which of these fluctuations are statistically significant. 

For that matter we conducted an analysis of variance on the demand by sandwich type and month, day of week and month-day of week. 
...
As we can see in the results above, the only statisticaly significant variation in the distribution of the demand is due to the sandwich type and month.
...
In addition, the data suggests that there is some variation in the demand from month to month. Adjusting his supply levels accordingly will help him maximize his profit.

We recomend that James adjustes his production levels according to the following table:
...
expected_demand_by_month <- data.frame(cast(expected_demand
                                            , month~sandwich
                                            , first
